...
public class DB {
  ...
  public <R> R tx(Supplier<R> supplier) {
  ...
  public int execute(Sql sql, int queryTimeout) {
    ...
    return this.execute(sql.getSqlString(), sql.getParams(), queryTimeout);
  }
  ...
  public <TModel> int create(Class<TModel> modelClass, TModel entity) {
    ...
    */
    ...
    this.sqlLog.showSql(sql.getSqlString(), sql.getParams());
    result =
  ...
  private <TModel> int createInJdbcBatch(ClassMeta classMeta, Collection<TModel> entities) {
    ...
    this.sqlLog.showBatchSql(sql.getSqlString(), paramsList);
  ...
  private <TModel> int updateByLines(
    ...
    this.sqlLog.showBatchSql(sql.getSqlString(), paramsList);
    result = database.updateBatch(sql.getSqlString(), paramsList);
