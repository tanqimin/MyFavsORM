...
public class Orm {
  ...
  public <TModel> int create(Class<TModel> modelClass, TModel entity) {
    ...
    */
    ...
    sql = this.database.getDialect().insert(modelClass, entity);
  ...
  private <TModel> int createInJdbcBatch(ClassMeta classMeta, Collection<TModel> entities) {
    ...
    sql = this.database.getDialect().insert(classMeta.getClazz());
  ...
  private <TModel> Object checkAndGeneratePKValue(GenerationType strategy, Attribute primaryKey, TModel entity) {
    ...
    switch (strategy) {
      case SNOW_FLAKE:
        pkVal = this.database.dbTemplate.getPkGenerator().nextSnowFakeId();
        break;
      case UUID:
        pkVal = this.database.dbTemplate.getPkGenerator().nextUUID();
        break;
      case ASSIGNED:
  ...
  public <TModel> int update(Class<TModel> modelClass, TModel entity) {
    ...
    Sql sql = this.database.getDialect().update(modelClass, entity, false)
  ...
  public <TModel> int updateIgnoreNull(Class<TModel> modelClass, TModel entity) {
    ...
    Sql sql = this.database.getDialect().update(modelClass, entity, true)
                           .and(Cond.logicalDelete(logicDelete));
    return execute(sql);
  }
