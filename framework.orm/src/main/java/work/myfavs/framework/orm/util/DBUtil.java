...
public class DBUtil {
   ...
   * @throws SQLException SQLException
   */
  public static PreparedStatement getPsForUpdate(Connection conn, boolean autoGeneratedPK, String sql, List<List<Object>> params,
                                                 int batchSize)
      throws SQLException {

    PreparedStatement pst = getPs(conn, autoGeneratedPK, sql);
    int               i   = 0;
    for (Iterator<List<Object>> iterator = params.iterator();
         iterator.hasNext(); ) {
   ...
   * @throws SQLException SQLException
   */
  private static PreparedStatement setParams(PreparedStatement preparedStatement, List<Object> params)
      throws SQLException {
