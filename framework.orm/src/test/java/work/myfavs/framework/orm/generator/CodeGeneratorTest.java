...
public class CodeGeneratorTest {
  ...
  public void setUp()
    ...
    config.getTypeMapper()
          .put("varchar", new TypeDefinition("java.lang.String"));
    config.getTypeMapper()
          .put("datetime", new TypeDefinition("java.util.Date"));
    config.getTypeMapper()
          .put("decimal", new TypeDefinition("java.math.BigDecimal", "BigDecimal.ZERO"));
    config.getTypeMapper()
          .put("bigint", new TypeDefinition("java.lang.Long", "long", "0L"));
    config.getTypeMapper()
          .put("int", new TypeDefinition("java.lang.Integer", "int", "0"));
    config.getTypeMapper()
          .put("bit", new TypeDefinition("java.lang.Boolean", "boolean", "false"));
